...
1. [SLICT](https://github.com/ntdathp/slict/tree/slict2_noetic)
2. [UFOMap (devel_surfel_noetic)](https://github.com/ntdathp/ufomap/tree/devel_surfel_noetic)
3. To compile the package for use with livox lidars (avia, mid-70, mid 360), you need to install [Livox ROS driver (forked)](https://github.com/ntdathp/livox_ros_driver) and [Livox ROS driver2 (forked)](https://github.com/ntdathp/livox_ros_driver2/tree/noetic) (you need to install [LIVOX-SDK](https://github.com/Livox-SDK/Livox-SDK) and [LIVOX-SDK2](https://github.com/Livox-SDK/Livox-SDK2))
...
cd slict_ws/src
git clone https://github.com/ntdathp/slict && cd slict && git checkout slict2_noetic && cd ..
...
git clone https://github.com/ntdathp/livox_ros_driver2 && cd livox_ros_driver2  && git checkout noetic && cd ..
cd .. && catkin build
```
